...
public class setupScreen {
	...
	private void initialize() {
		...
		window.setBounds(100, 100, 1184, 907);
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
								.addComponent(panel, GroupLayout.DEFAULT_SIZE, 1150, Short.MAX_VALUE)
								.addGroup(groupLayout.createSequentialGroup()
									.addGap(315)
									.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
										.addGroup(groupLayout.createSequentialGroup()
										...
										.addGroup(groupLayout.createSequentialGroup()
											...
											.addPreferredGap(ComponentPlacement.RELATED)
											.addComponent(maxDaySlider, GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE))
										.addGroup(groupLayout.createSequentialGroup()
										...
										.addGroup(groupLayout.createSequentialGroup()
											.addGap(77)
											.addComponent(lblNewLabel, GroupLayout.DEFAULT_SIZE, 313, Short.MAX_VALUE)
											.addGap(79)))
									.addGap(366)))
							.addContainerGap())
